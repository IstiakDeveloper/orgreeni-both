...
import { ChevronRight, ShoppingBag, Clock, Percent, CheckCircle } from 'lucide-react';
...
const Home: React.FC<HomeProps> = ({ categories, featuredProducts, banners, newArrivals, storeSettings }) => {
    ...
    return (
        <ShopLayout>
            ...
            >
                {/* Hero Section with Banner and Quick Search */}
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-transparent flex items-center">
                                <div className="text-white ml-8 md:ml-16 max-w-lg">
                                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Fresh Groceries Delivered Fast</h1>
                                    <p className="text-lg md:text-xl mb-6">Shop our wide selection of fresh, high-quality groceries delivered to your doorstep.</p>
                                    <Link
                                        href="/products"
                                        className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-md font-medium text-lg transition-colors inline-block"
                                    >
                                        Shop Now
                                    </Link>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden mb-10">
                        <div className="bg-green-500 py-3">
                            <h2 className="text-xl font-bold text-white text-center">Why Shop With Us</h2>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                            <div className="p-6 flex items-center">
                                <div className="w-12 h-12 flex-shrink-0 mr-4 bg-green-100 rounded-full flex items-center justify-center">
                                    <ShoppingBag className="w-6 h-6 text-green-600" />
                                </div>
                                <div>
                                    <span className="text-lg font-bold text-green-600">15,000+ Products</span>
                                    <p className="text-gray-600 text-sm mt-1">Wide selection of groceries</p>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex items-center">
                                ...
                                <div>
                                    <span className="text-lg font-bold text-green-600">Pay After Delivery</span>
                                    <p className="text-gray-600 text-sm mt-1">Cash on delivery available</p>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex items-center">
                                ...
                                <div>
                                    <span className="text-lg font-bold text-green-600">1-Hour Delivery</span>
                                    <p className="text-gray-600 text-sm mt-1">Quick and reliable service</p>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex items-center">
                                ...
                                <div>
                                    <span className="text-lg font-bold text-green-600">Regular Offers</span>
                                    <p className="text-gray-600 text-sm mt-1">Save money on groceries</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <Link href="/categories" className="text-green-600 hover:text-green-700 flex items-center text-sm font-medium bg-green-50 px-4 py-2 rounded-md">
                                View All
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            {categories.slice(0, 6).map((category) => (
                                ...
                                >
                                    <div className="aspect-square p-4 flex items-center justify-center bg-gray-50 group-hover:bg-green-50 transition-colors">
                                        <img
                                    ...
                                    <div className="p-3 text-center border-t border-gray-100 group-hover:bg-green-500 group-hover:text-white transition-colors">
                    ...
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <Link href="/products/featured" className="text-green-600 hover:text-green-700 flex items-center text-sm font-medium bg-green-50 px-4 py-2 rounded-md">
                                View All
                                <ChevronRight className="h-4 w-4 ml-1" />
                            </Link>
                        </div>
                    ...
                    {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                        <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl shadow-md overflow-hidden">
                            <div className="p-6 text-white flex flex-col h-full justify-between">
                                <div>
                                    ...
                                    <p className="mb-4">Get up to 30% off on seasonal fruits and vegetables.</p>
                                </div>
                                <Link href="/category/seasonal-offers" className="bg-white text-orange-600 hover:bg-orange-50 px-4 py-2 rounded-md font-medium inline-block w-max">
                                    Shop Now
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl shadow-md overflow-hidden">
                            <div className="p-6 text-white flex flex-col h-full justify-between">
                                <div>
                                    <h3 className="text-2xl font-bold mb-2">Imported Products</h3>
                                    <p className="mb-4">Discover our collection of premium imported groceries.</p>
                                </div>
                                <Link href="/category/imported" className="bg-white text-blue-600 hover:bg-blue-50 px-4 py-2 rounded-md font-medium inline-block w-max">
                                    Explore
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-green-600 to-green-500 rounded-xl shadow-md mb-12 overflow-hidden">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="md:w-1/2 p-8">
                                <h2 className="text-3xl font-bold text-white mb-4">Download Our App</h2>
                                <p className="text-green-50 mb-6">Shop groceries anytime, anywhere with our mobile app. Get exclusive app-only offers and discounts.</p>
                            ...
                            <div className="md:w-1/2 p-4 flex justify-center">
                                <img src="/assets/app-mockup.png" alt="Mobile App" className="max-w-xs transform -rotate-6 shadow-xl rounded-xl" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer className="bg-white shadow-md border-t border-gray-200 pt-12 pb-6">
