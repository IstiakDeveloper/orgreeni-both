...
const Create: React.FC<CreateBannerProps> = ({ errors }) => {
  ...
  const handleSubmit: FormEventHandler = (e) => {
    ...
    post(route('admin.banners.store'), formData);
  };
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Create Banner</h3>
              <p className="mt-1 text-sm text-gray-600">
                Add a new promotional banner to be displayed on your store's homepage or other areas.
                Banners can include links to specific products, categories, or external URLs.
              </p>
              <div className="mt-6">
                ...
                <div className="flex items-center mt-2">
                  <CircleCheck className="h-5 w-5 text-emerald-500" />
                  <span className="ml-2 text-sm text-gray-600">Recommended banner image size is 1200×400 pixels</span>
                </div>
              </div>
            </div>
          </div>
