...
const Create: React.FC<CreateAreaProps> = ({ errors }) => {
  const { data, setData, post, processing } = useForm({
    name: '',
    city: '',
    is_serviceable: true,
    delivery_charge: '' as unknown as number,
  });
  ...
  return (
    <AdminLayout title="Create Delivery Area">
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Create Delivery Area</h3>
              <p className="mt-1 text-sm text-gray-600">
                Add a new delivery area with its associated city and delivery charge. This will be available for customers during checkout.
              </p>
              <div className="mt-6">
